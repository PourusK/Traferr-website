  ...
  return (
    <div className="flex flex-col gap-24 pb-24">
      <section className="relative isolate overflow-hidden bg-gradient-to-b from-sky-50 via-white to-white">
        <div
          className="pointer-events-none absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-sky-200/50 blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute top-1/3 right-[12%] h-[360px] w-[360px] rounded-full bg-indigo-100/40 blur-3xl"
          aria-hidden
        />
